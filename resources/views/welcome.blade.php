...
@section('content')
                    ...
                    <div class="col-lg-4">
                        <div class="card bg-light mb-3 text-center mx-auto">
                            ...
                            <div class="card-body align-items-center d-flex justify-content-center">
                                <a class="btn btn-primary" href="{{ url('/home') }}">{{__('welcome_dashbords.userArea')}}</a>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="col-lg-4">
                        <div class="card bg-light mb-3 text-center mx-auto">
                            ...
                            <div class="card-body align-items-center d-flex justify-content-center">
                                <a class="btn btn-primary" href="{{ route('login') }}">{{__('welcome_dashbords.loginAsUser')}}</a>
                            </div>
                        </div>
                    </div>
                    @if (Route::has('register'))
                        <div class="col-lg-4">
                            <div class="card bg-light mb-3 text-center mx-auto">
                                ...
                                <div class="card-body align-items-center d-flex justify-content-center">
                                    <a class="btn btn-primary" href="{{ route('register') }}">{{__('welcome_dashbords.registerUser')}}</a>
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                @if(Auth::guard('admin')->check())
                    <div class="col-lg-4">
                        <div class="card bg-light mb-3 text-center mx-auto">
                            ...
                            <div class="card-body align-items-center d-flex justify-content-center">
                                <a class="btn btn-primary" href="{{ url('/admin') }}">{{__('welcome_dashbords.adminArea')}}</a>
                            </div>
                        </div>
                    </div>
                @else
    ...
    <path d="M4 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
                            ...
                            <div class="card-body align-items-center d-flex justify-content-center">
                                <a class="btn btn-primary" href="{{ route('admin.login') }}">{{__('welcome_dashbords.loginAsAdmin')}}</a>
                            </div>
                        </div>
                    </div>
                @endif
